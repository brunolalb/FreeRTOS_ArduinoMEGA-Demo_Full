 ...
 * IDE: Eclipse Mars.2
 *
 * This file was based on the ATmega323 official port
 *
...
#define portDISABLE_INTERRUPTS()	cli(); //asm volatile ( "cli" :: );
#define portENABLE_INTERRUPTS()		sei(); //asm volatile ( "sei" :: );
/*-----------------------------------------------------------*/
